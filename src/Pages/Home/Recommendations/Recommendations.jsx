...
const Recommendations = () => {
  ...
  return (
    ...
    <div>
      ...
      <Link to="/blog" className="text-2xl font-medium text-secondary hover:text-secondaryHover flex gap-3 items-center"><FaArrowRightLong />View All Blog Posts</Link>
      </div>
    </div>
    </>
  );
