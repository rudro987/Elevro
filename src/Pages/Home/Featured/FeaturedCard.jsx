      ...
      <div className="flex flex-col gap-4 justify-center p-7">
        ...
        <div className="grid grid-cols-2">
          ...
          <RiReservedFill className="text-secondary text-base" />
            <p className="text-sm text-bodyText"> Reservations: {test.bookings}</p>
          </div>
          <div className="pt-5 flex gap-2 items-center">
        ...
        <Link to={`/all-tests/${test._id}`} className="bg-primary py-3 hover:bg-primaryHover w-full rounded-lg text-menuText text-lg font-medium">
